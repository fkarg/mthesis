...
During this work, a lot of effort was put in attempting to fine-tune the models used (See \secref{res:sft} for details on \informal{our} work, and \subref{finetune} for details on training and fine-tuning \glspl{LM} in general).
...
While attempted, \informal{we} where not successfull in fine-tuning one of the selected models (See \secref{res:sft} for details on \informal{our} work on fine-tuning, and \subref{finetune} for details on training and fine-tuning \glspl{LM} in general).
