...
% well, not properly, but I gotta live with that now


% collection of todos
% \todo{move image descriptions away from description in referencing text}
% \todo{check if all acronyms and glossary term descriptions are ok}
% \todo{remove todos from table of contents and inclusion}
