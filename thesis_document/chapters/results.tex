...
As can be seen in \figref{7b_acc}, accuracy in extracting \ttemp and \ttime data varies wildlyacross models, and good performance in one does not always correlate with good performance in the other.
